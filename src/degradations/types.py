...
class DegradationType(Enum):
    ...
    ARTIFACT_MOTION = "artifact_motion"
    ARTIFACT_BEAM_HARDENING = "artifact_beam_hardening"
    ARTIFACT_SCATTER = "artifact_scatter"
    ARTIFACT_TRUNCATION = "artifact_truncation"
    ARTIFACT_SPARSE_VIEW = "artifact_sparse_view"
    ARTIFACT_LIMITED_ANGLE = "artifact_limited_angle"
    ARTIFACT_FOCAL_SPOT_BLUR = "artifact_focal_spot_blur"
